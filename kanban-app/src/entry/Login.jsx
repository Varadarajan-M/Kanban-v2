...
const Login = () => {
	...
	const onLogin = async (userCreds) => {
		...
		isResOk(res) ? navigate('/home') : alert(res?.error?.message ?? 'Something went wrong');
	};
	...
	return (
		<div className='container'>
			...
			<div className='wrapper'>
				<AuthForm isProcessingReq={isProcessingReq} mode={'login'} onSubmit={onLogin} />
				<div className='signup-redirect'>
					<span>
						New to Kanban App? <Link to='/signup'>Create an account</Link>
					</span>
				</div>
			</div>
		</div>
