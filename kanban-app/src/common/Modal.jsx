...
const Modal = ({ open, onBackdropClick, title, children, onPrimaryClick, onSecondaryClick, primaryButton, secondaryButton }) => {
	const className = `modal modal-sm ${open ? 'active' : ''}`;
	return (
		<div className={className}>
			<span className='modal-overlay' aria-label='Close' onClick={onBackdropClick} />
			<div className='modal-container'>
				<div className='modal-header'>
					<span className='btn btn-clear text-light mt-2 float-right' aria-label='Close' onClick={onBackdropClick} />
